...
const OrderDetail = () => {
  ...
  const handleSearch = (value) => {
    ...
    const filteredResults = order.filter((item) => {
      if (category === "All") {
        return (
          item.Name.toLowerCase().includes(searchValue) ||
          item.OrderType?.toLowerCase().includes(searchValue) ||
          item.OrderDate.toString().includes(searchValue) ||
          (item.Status.toLowerCase().includes(searchValue)
        ));
      } else if (category === "Name") {
        return item.Name.toLowerCase().includes(searchValue);
      } else if (category === "OrderType") {
        return item.OrderType?.toLowerCase().includes(searchValue);
      } else if (category === "OrderDate") {
        return item.OrderDate.toString().includes(searchValue);
      ...
      <div className="background-overlay">
        <div className="content-wrapper">
          <div className="search-header">
            ...
            <p className="subtitle">Manage and Explore all of your Orders</p>
            <div className="search-tools">
              ...
              >
                ...
                <option value="OrderType">Category</option>
