                    ...
                    {[
                      ...
                      <div className="col-md-6" key={index}>
                        <div className="form-group">
                          ...
                          >
                            <option value="" style={{ backgroundColor: "rgba(1, 32, 93, 0.9)", color: "#fff" }}>
                              Select Status
                            </option>
                            <option value="Confirmed" style={{ backgroundColor: "rgba(1, 32, 93, 0.9)", color: "#fff" }}>
                              Confirmed
                            </option>
                            <option value="Pending" style={{ backgroundColor: "rgba(1, 32, 93, 0.9)", color: "#fff" }}>
                              Pending
                            </option>
                            <option value="Cancelled" style={{ backgroundColor: "rgba(1, 32, 93, 0.9)", color: "#fff" }}>
                              Cancelled
                            </option>
                          </select>
                          ) : (
