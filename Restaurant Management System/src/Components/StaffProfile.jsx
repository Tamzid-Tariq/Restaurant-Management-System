...
//   const handleDelete = () => {
//     fetch(`http://localhost:3000/deleteStaff/${user.StaffID}`, {
//       method: "DELETE",
//     })
...
const handleDelete = async () => {
    ...
    try {
        const response = await fetch(`http://localhost:3000/api/staff/${user.StaffID}`, {
            method: 'DELETE'
        });
  ...
  const handleUpdate = async () => {
    try {
      ...
      formData.append("ContactDetails", updatedUser.ContactDetails);
      formData.append("Role", updatedUser.Role);
      formData.append("ShiftTiming", updatedUser.ShiftTiming);
      ...
      const response = await fetch(
        `http://localhost:3000/api/staff/${user.StaffID}`,
        {
          method: "PUT",
