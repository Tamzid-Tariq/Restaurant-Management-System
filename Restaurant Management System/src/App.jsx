  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/customerdash/customerportal" element={<CustomerPortal />}></Route>
        {/* <Route path="/customerdash/user-profile/:id" element={<UserDetail />}></Route> */}
          <Route path="/customerdash/user-profile" element={<CustomerProfile />}></Route>
          {/* <Route path="/customerdash/user-profile" element={<CustomerUserDetail />}></Route> */}
